...
public class ConstantsMessage {//這個是裝constants的訊息，是常數，所以要+final
	...
	public static final String QUIZ_START_DATE_ERROR = "Quiz start date error!!";
		
	public static final String QUIZ_END_DATE_ERROR = "Quiz end date error!!";
	...
	public static final String USER_PHONE_ERROR = "User phone error!!";
	
	public static final String USER_GENDER_ERROR = "User gender error!!";
	
	public static final String USER_AGE_ERROR = "User age error!!";
	
	public static final String USER_INFO_IS_NULL = "User info is null!!";
	
	public static final String QUIZ_ID_ERROR = "Quiz id list is error!!";
