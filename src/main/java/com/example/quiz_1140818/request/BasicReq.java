...
public class BasicReq { //這個主要是用在controller
	...
	@Pattern(regexp = "\\w{3,8}",message = "Account format error!!") //允許使用正規表達式
	private String account;
	
	@NotBlank(message = ConstantsMessage.PARAM_PASSWORD_ERROR)
	@Pattern(regexp = "\\w{3,8}",message = "Password Account format error!!") //帳號密碼的限制可以自己制定，老師沒有規定
