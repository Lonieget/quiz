package com.example.quiz_1140818.exception;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<Map<String, Object>> paramExceptionHandler(MethodArgumentNotValidException e) {
		...
		errorMap.put("code", HttpStatus.BAD_REQUEST.value()); //這裡的code是連動BasicRes裡的code，bad_request是參照postman裡的error
		// 即使有多個錯誤參數，但還是一個個處理，所以會取第一個錯誤訊息
		errorMap.put("message", e.getAllErrors().get(0).getDefaultMessage()); //取0是因為要取第一個訊息去處理
